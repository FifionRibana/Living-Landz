...
use hexx::{PlaneMeshBuilder, HexLayout, HexOrientation, MeshInfo};

/// Crée un mesh hexagonal en utilisant hexx::ColumnMeshBuilder
pub fn create_hexagon_mesh(layout: HexLayout, radius: f32) -> Mesh {
